...
# --- ECB endpoints -----------------------------------------------------------
ECB_FM_CSV = (
    "https://data-api.ecb.europa.eu/service/data/FM/{key}"
    "?format=csvdata&startPeriod={start}"
)
KEY_RATE_SERIES = {
    "mro": "D.U2.EUR.4F.KR.MRR_FR.LEV",  # main refinancing operations fixed rate
...
EURO_ADOPTION = {
    "AT": "1999-01-01", "BE": "1999-01-01", "DE": "1999-01-01", "ES": "1999-01-01",
    "FI": "1999-01-01", "FR": "1999-01-01", "IE": "1999-01-01", "IT": "1999-01-01",
    "LU": "1999-01-01", "NL": "1999-01-01", "PT": "1999-01-01", "GR": "2001-01-01",
    "SI": "2007-01-01", "CY": "2008-01-01", "MT": "2008-01-01", "SK": "2009-01-01",
    "EE": "2011-01-01", "LV": "2014-01-01", "LT": "2015-01-01", "HR": "2023-01-01",
}
